			...
			<div class="col-md-12">
				...
				<table class="table table-striped table-hover">
					...
					<?php
						...
						if ($is_admin){
							echo "<thead>
									<th><H3>Ver equipo</H3></th>
									<th><H3>Asignar equipo</H3></th>
								</thead>";
						}
					...
					<?php
						while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
							...
							if ($is_admin){
								echo "<tr><td><a href='miembros.php?id_proyecto=".$row["idProyecto"]."'>".$row["nombreProyecto"]."</td>
								<td><a href='asignar_usuario.php?id_proyecto=".$row["idProyecto"]."'><i class='glyphicon glyphicon-plus'></i></td></tr>";
							}
							else {
