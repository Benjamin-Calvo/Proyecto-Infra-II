...
<body>
  ...
  ?>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<form role="form" action="../acciones/insertar_sprint.php" method="POST">  <!--Esto es lo que hace que el boton llame a insersprint-->
					<br>
          <div class="col-md-12">
				   	<div class="form-group">
				    	<label for="numero_sprint">Numero de Sprint:</label>
				    	<input name="numero_sprint" type="text" class="form-control minimizar_ancho" id="numero_sprint" placeholder="#Sprint">
				    </div>
          </div>
				    <div class="col-md-12">
                ...
                <div class="col-md-12">
                      <label for="a">Dias habiles por semana:</label>
                </div>
                <div class="col-md-1">
                      <input name="dias_habiles" type="text" class="form-control" id="a" placeholder="Dia">
                </div>
